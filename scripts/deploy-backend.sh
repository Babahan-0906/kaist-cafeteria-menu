...
gcloud run deploy $SERVICE_NAME \
    ...
    --set-env-vars "TELEGRAM_BOT_TOKEN=$TELEGRAM_BOT_TOKEN,TELEGRAM_CHAT_ID=$TELEGRAM_CHAT_ID,GEMINI_API_KEY=$GEMINI_API_KEY,GIT_ACTIONS_WEBHOOK_SECRET=$GIT_ACTIONS_WEBHOOK_SECRET,CLOUD_SCHEDULER_SECRET=$CLOUD_SCHEDULER_SECRET,GITHUB_TOKEN=$GITHUB_TOKEN"